...
Define the requirements for rendering Mermaid diagrams using the beautiful-mermaid engine, including supported diagram types, theming, layout engine, and rendering details.
